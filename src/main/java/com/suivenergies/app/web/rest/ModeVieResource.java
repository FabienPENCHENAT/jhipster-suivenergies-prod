...
public class ModeVieResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new modeVie, or with status {@code 400 (Bad Request)} if the modeVie has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated modeVie,
     * or with status {@code 400 (Bad Request)} if the modeVie is not valid,
     * or with status {@code 500 (Internal Server Error)} if the modeVie couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of modeVies in body.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the modeVie, or with status {@code 404 (Not Found)}.
     */
