...
import com.suivenergies.app.web.rest.errors.EmailAlreadyUsedException;
import com.suivenergies.app.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable String login) {
        ...
        userRepository
            ...
            .ifPresent(
                user -> {
                    // Delete client associated to the user.
                    clientRepository
                        .findOneByUsersId(user.getId())
                        .ifPresent(
                            client -> {
